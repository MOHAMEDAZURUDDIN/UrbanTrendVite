...
import highlightsImg from "../../assets/flex.png";
const FlexContents = () => {
  return (
    <>
      <div
        className={`flex items-center justify-between lg:flex-col lg:justify-center nike-container flex-row px-24 mt-20`}
      >
        <div className="max-w-lg lg:max-w-none w-full md:text-center grid items-center lg:justify-items-center">
          <div className="flex flex-col items-center justify-center">
            ...
            <h1 className="text-5xl lg:text-4xl md:text-3xl sm:text-2xl font-bold text-slate-900 filter drop-shadow-lg">
              Mizuno <span className="text-coral-red">x</span> Enerzy
            </h1>
            
              <p className="xl:text-sm my-4 text-slate-900">
                The Mizuno Genesis merges the worlds of digital art
        ...
        <div className="flex items-center justify-center max-w-xl relative lg:max-w-none w-full">
          <img
            src={highlightsImg}
            alt={`img/highlights`}
            className={`w-auto object-fill transitions-theme h-1/2 lg:h-96 md:h-60 sm:h-44 xsm:h-40 rotate-12 hover:-rotate-45 `}
          />
        </div>
      </div>
    </>
