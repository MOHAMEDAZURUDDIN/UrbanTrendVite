...
export default function UserList() {
      ...
      users.map((user) => ({
        ...
        actions: (
          <div className="flex justify-center items-center ">
            <Link to={`/admin/user/${user._id}`} className="mr-2 text-white-400">
              <BsPencilFill />
            </Link>
            <button
  ...
  return (
    <>
      ...
      <div
        className={`relative opacity-100 z-20 font-montserrat text-pale-blue px-4 min-h-screen`}
      >
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 ">
          ...
          <div className="col-span-1 md:col-span-10 mb-4">
            ...
            {loading ? (
              ...
              <div className="bg-slate-700 overflow-x-auto mt-4 sm:mt-40">
                <table
                  {...getTableProps()}
